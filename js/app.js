...
function initAnimation() {
	...
	setTimeout(function(){
		$cloud.css("opacity", "0");
		$player.css("top", "30px");
		$santa.css("bottom", "-20px");
		$el.css("background", originalColor);
		$sun.css("background", "#ef9756");
		$(document).snowfall({deviceorientation : false, round : true, minSize: 1, maxSize:8,  flakeCount : 150});
		initPlayer();
	}, x);
}

function initPlayer() {
	var source = "images/dean-martin-let-it-snow.mp3";
	var audio = new Audio();
